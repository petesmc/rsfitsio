...
mod tests {
    ...
    unsafe fn test_sscanf_int_with_libc(input: &str, format: &str) -> (c_int, c_int) {
        unsafe {
            #[cfg(not(target_family = "windows"))]
            {
                ...
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut our_val) as *const c_void));
    ...
    unsafe fn test_sscanf_uint_with_libc(input: &str, format: &str) -> (c_int, c_uint) {
        unsafe {
            #[cfg(not(target_family = "windows"))]
            {
                ...
                let mut valist = CustomVaList::new();
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_uint>(&mut our_val) as *const c_void));
    ...
    unsafe fn test_sscanf_long_with_libc(input: &str, format: &str) -> (c_int, c_long) {
        unsafe {
            #[cfg(not(target_family = "windows"))]
            {
                ...
                let mut valist = CustomVaList::new();
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_long>(&mut our_val) as *const c_void));
    ...
    unsafe fn test_sscanf_char_with_libc(input: &str, format: &str) -> (c_int, c_char) {
        unsafe {
            #[cfg(not(target_family = "windows"))]
            {
                ...
                let mut valist = CustomVaList::new();
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_char>(&mut our_val) as *const c_void));
    ...
    unsafe fn test_sscanf_two_ints_with_libc(input: &str, format: &str) -> (c_int, c_int, c_int) {
        unsafe {
            #[cfg(not(target_family = "windows"))]
            {
                ...
                let mut valist = CustomVaList::new();
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut our_val1) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut our_val2) as *const c_void));
    ...
    fn test_scanf_f_comprehensive() {
        // Test 1: Simple float
        {
            ...
            let mut valist = CustomVaList::new();
            valist.push(VaArg::pointer(core::ptr::from_mut::<c_double>(&mut val) as *const c_void));
        ...
        // Test 10: Multiple floats
        {
            ...
            let mut valist = CustomVaList::new();
            valist.push(VaArg::pointer(core::ptr::from_mut::<c_double>(&mut val1) as *const c_void));
            valist.push(VaArg::pointer(core::ptr::from_mut::<c_double>(&mut val2) as *const c_void));
    ...
    fn test_scanf_ld_comprehensive() {
        unsafe {
            ...
            // Test 5: Multiple long integers
            {
                ...
                let mut valist = CustomVaList::new();
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_long>(&mut val1) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_long>(&mut val2) as *const c_void));
            ...
            // Test 6: Long hex
            {
                ...
                let mut valist = CustomVaList::new();
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_long>(&mut val) as *const c_void));
    ...
    fn test_scanf_c_comprehensive() {
        // Test 1: Single character
        {
            ...
            let mut valist = CustomVaList::new();
            valist.push(VaArg::pointer(core::ptr::from_mut::<c_char>(&mut val) as *const c_void));
        ...
        // Test 4: Multiple characters
        {
            ...
            let mut valist = CustomVaList::new();
            valist.push(VaArg::pointer(core::ptr::from_mut::<c_char>(&mut val1) as *const c_void));
            valist.push(VaArg::pointer(core::ptr::from_mut::<c_char>(&mut val2) as *const c_void));
    ...
    fn test_scanf_mixed_comprehensive() {
        unsafe {
            // Test 1: Integer and string
            {
                ...
                let mut buffer: [c_char; 100] = [0; 100];
                let mut valist = CustomVaList::new();
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut val) as *const c_void));
                valist.push(VaArg::pointer(buffer.as_mut_ptr() as *const c_void));
            ...
            // Test 2: Float and integer
            {
                ...
                let mut valist = CustomVaList::new();
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_double>(&mut fval) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut ival) as *const c_void));
            ...
            // Test 3: Hex, decimal, and string
            {
                ...
                let mut buffer: [c_char; 100] = [0; 100];
                let mut valist = CustomVaList::new();
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_uint>(&mut hex_val) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut dec_val) as *const c_void));
                valist.push(VaArg::pointer(buffer.as_mut_ptr() as *const c_void));
            ...
            // Test 4: Character and integer
            {
                ...
                let mut ival: c_int = 0;
                let mut valist = CustomVaList::new();
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_char>(&mut cval) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut ival) as *const c_void));
            ...
            // Test 5: Multiple formats with complex whitespace
            {
                ...
                let mut buffer: [c_char; 100] = [0; 100];
                let mut valist = CustomVaList::new();
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut val1) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_double>(&mut val2) as *const c_void));
                valist.push(VaArg::pointer(buffer.as_mut_ptr() as *const c_void));
    ...
    fn test_scanf_edge_cases() {
        ...
        // Test 4: Partial match
        {
            ...
            let mut valist = CustomVaList::new();
            valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut val1) as *const c_void));
            valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut val2) as *const c_void));
        ...
        // Test 6: Hex without valid hex digits
        {
            ...
            let mut valist = CustomVaList::new();
            valist.push(VaArg::pointer(core::ptr::from_mut::<c_uint>(&mut val) as *const c_void));
    ...
    fn test_scanf_many() {
        unsafe {
            ...
            // Test 6: Mixed numeric formats
            {
                ...
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut dec_val) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_uint>(&mut hex_val) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_uint>(&mut oct_val) as *const c_void));
    ...
    fn test_scanf_extreme_edge_cases() {
        unsafe {
            ...
            // Test 3: Many consecutive format specifiers
            {
                ...
                let mut valist = CustomVaList::new();
                for i in 0..10 {
                    valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut vals[i]) as *const c_void));
                }
            ...
            // Test 8: Mixed with many whitespace variations
            {
                ...
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut val1) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut val2) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut val3) as *const c_void));
    ...
    fn test_scanf_n_debug() {
        ...
        let mut valist = CustomVaList::new();
        valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut our_val) as *const c_void));
        valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut our_n) as *const c_void));
    ...
    fn test_scanf_n_multiple() {
        ...
        unsafe {
            ...
            #[cfg(not(target_family = "windows"))]
            {
                ...
                let mut valist = CustomVaList::new();
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut our_v1) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut our_n1) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut our_v2) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut our_n2) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut our_v3) as *const c_void));
                valist.push(VaArg::pointer(core::ptr::from_mut::<c_int>(&mut our_n3) as *const c_void));
