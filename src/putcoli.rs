...
pub(crate) fn ffp3di_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        // fits_write_compressed_img(fptr, TSHORT, fpixel, lpixel,     0,  array, None, status);
...
pub fn ffpssi_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        /* this is a compressed image in a binary table */
        todo!();
        //fits_write_compressed_img(fptr, TSHORT, fpixel, lpixel, 0,  array, NULL, status);
