...
pub fn ffpprsb_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_write_compressed_pixels(fptr, TSBYTE, firstelem, nelem,  0, array, &nullvalue, status);
        return *status;
    }
...
pub(crate) fn ffppnsb_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_write_compressed_pixels(fptr, TSBYTE, firstelem, nelem, 1, array, &nullvalue, status);
        return *status;
    }
...
pub(crate) fn ffp3dsb_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_write_compressed_img(fptr, TSBYTE, fpixel, lpixel,  0,  array, NULL, status);
