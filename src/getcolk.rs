...
pub fn ffgpvk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_read_compressed_pixels(fptr, TINT, firstelem, nelem, nullcheck, &nullvalue, array, NULL, anynul, status);
        return *status;
    }
...
pub fn ffgpfk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_read_compressed_pixels(fptr, TINT, firstelem, nelem,          nullcheck, NULL, array, nularray, anynul, status);
        return *status;
    }
...
pub fn ffg3dk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        nullvalue = nulval; /* set local variable */
        todo!();
        //fits_read_compressed_img(fptr, TINT, fpixel, lpixel, inc,            nullcheck, &nullvalue, array, NULL, anynul, status);
        return *status;
    }
...
pub fn ffgsvk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        nullvalue = nulval; /* set local variable */
        todo!();
        // fits_read_compressed_img(fptr, TINT, blcll, trcll, inc,            nullcheck, &nullvalue, array, NULL, anynul, status);
        return *status;
    }
...
pub fn ffgsfk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        // fits_read_compressed_img(fptr, TINT, blcll, trcll, inc,     nullcheck, NULL, array, flagval, anynul, status);
        return *status;
    }
