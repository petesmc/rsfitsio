...
pub fn ffgpvd_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_read_compressed_pixels(fptr, TDOUBLE, firstelem, nelem, nullcheck, &nullvalue, array, NULL, anynul, status);
        return *status;
    }
...
pub fn ffgpfd_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_read_compressed_pixels(fptr, TDOUBLE, firstelem, nelem,          nullcheck, NULL, array, nularray, anynul, status);
        return *status;
    }
...
pub fn ffg3dd_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        nullvalue = nulval; /* set local variable */
        todo!();
        //fits_read_compressed_img(fptr, TDOUBLE, fpixel, lpixel, inc,            nullcheck, &nullvalue, array, NULL, anynul, status);
        return *status;
    }
...
pub fn ffgsvd_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        nullvalue = nulval; /* set local variable */
        todo!();
        // fits_read_compressed_img(fptr, TDOUBLE, blcll, trcll, inc,            nullcheck, &nullvalue, array, NULL, anynul, status);
        return *status;
    }
...
pub unsafe extern "C" fn ffgsfd(
    ...
    unsafe {
        ...
        if fits_is_compressed_image_safe(fptr, status) > 0 {
            ...
            todo!();
            // fits_read_compressed_img(fptr, TDOUBLE, blcll, trcll, inc,     nullcheck, NULL, array, flagval, anynul, status);
            return *status;
        }
