...
pub fn ffppruj_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_write_compressed_pixels(fptr, TULONG, firstelem, nelem, 0, array, &nullvalue, status);
        return *status;
    }
...
pub(crate) fn ffppnuj_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_write_compressed_pixels(fptr, TULONG, firstelem, nelem,  1, array, &nullvalue, status);
        return *status;
    }
...
pub(crate) fn ffp3duj_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_write_compressed_img(fptr, TULONG, fpixel, lpixel, 0,  array, NULL, status);
...
pub fn ffpssuj_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        /* this is a compressed image in a binary table */
        todo!();
        //fits_write_compressed_img(fptr, TULONG, fpixel, lpixel,    0,  array, None, status);
