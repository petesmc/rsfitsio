...
pub fn ffgpvuk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_read_compressed_pixels(fptr, TUINT, firstelem, nelem, nullcheck, &nullvalue, array, NULL, anynul, status);
        return *status;
    }
...
pub fn ffgpfuk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_read_compressed_pixels(fptr, TUINT, firstelem, nelem,          nullcheck, NULL, array, nularray, anynul, status);
        return *status;
    }
...
pub fn ffg3duk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        nullvalue = nulval; /* set local variable */
        todo!();
        //fits_read_compressed_img(fptr, TUINT, fpixel, lpixel, inc,            nullcheck, &nullvalue, array, NULL, anynul, status);
        return *status;
    }
...
pub fn ffgsvuk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        nullvalue = nulval; /* set local variable */
        todo!();
        // fits_read_compressed_img(fptr, TUINT, blcll, trcll, inc,            nullcheck, &nullvalue, array, NULL, anynul, status);
        return *status;
    }
...
pub fn ffgsfuk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        // fits_read_compressed_img(fptr, TUINT, blcll, trcll, inc,     nullcheck, NULL, array, flagval, anynul, status);
        return *status;
    }
