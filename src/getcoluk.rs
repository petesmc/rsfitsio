...
pub fn ffgpvuk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_read_compressed_pixels(fptr, TUINT, firstelem, nelem, nullcheck, &nullvalue, cast_slice_mut(array), None, anynul, status);
        return *status;
    }
...
pub fn ffgpfuk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        //fits_read_compressed_pixels(fptr, TUINT, firstelem, nelem,          nullcheck, None, cast_slice_mut(array), nularray, anynul, status);
        return *status;
    }
...
pub fn ffg3duk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        nullvalue = nulval; /* set local variable */
        todo!();
        //fits_read_compressed_img(fptr, TUINT, fpixel, lpixel, inc,            nullcheck, &nullvalue, cast_slice_mut(array), None, anynul, status);
        return *status;
    }
...
pub fn ffgsvuk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        nullvalue = nulval; /* set local variable */
        todo!();
        // fits_read_compressed_img(fptr, TUINT, blcll, trcll, inc,            nullcheck, &nullvalue, cast_slice_mut(array), None, anynul, status);
        return *status;
    }
...
pub fn ffgsfuk_safe(
    ...
    if fits_is_compressed_image_safe(fptr, status) > 0 {
        ...
        todo!();
        // fits_read_compressed_img(fptr, TUINT, blcll, trcll, inc,     nullcheck, None, cast_slice_mut(array), flagval, anynul, status);
        return *status;
    }
    ...
    if mem::size_of::<c_int>() == mem::size_of::<c_short>() {
        ...
        */
        ...
        if nultyp == NullCheckType::SetPixel && nulval == 0 {
            ...
            && (tnull > c_uint::MAX as LONGLONG || tnull < c_uint::MIN as LONGLONG)
        {
        ...
        if tcode == TLONG {
            ...
            if nelem < (INT32_MAX / 4) as LONGLONG {
                maxelem = nelem;
            } else {
    ...
    if nullcheck == NullCheckType::None {
        ...
        if scale == 1.0 && zero == 9223372036854775808. {
            ...
            for ii in 0..(ntodo as usize) {
                ...
                if ulltemp > c_uint::MAX as ULONGLONG {
                    *status = OVERFLOW_ERR;
                    output[ii] = c_uint::MAX;
                } else {
            ...
            for ii in 0..(ntodo as usize) {
                if input[ii] < 0 {
                    *status = OVERFLOW_ERR;
                    output[ii] = c_uint::MIN;
                } else if input[ii] > c_uint::MAX as LONGLONG {
                    *status = OVERFLOW_ERR;
                    output[ii] = c_uint::MAX;
                } else {
                    output[ii] = input[ii] as _;
...
pub(crate) fn fffr4uint(
    ...
    if nullcheck == NullCheckType::None {
        ...
        if scale == 1.0 && zero == 0.0 {
            /* no scaling */
            for ii in 0..(ntodo as usize) {
                if (input[ii] as f64) < DUINT_MIN {
                    *status = OVERFLOW_ERR;
                    output[ii] = c_uint::MIN;
                } else if (input[ii] as f64) > DUINT_MAX {
                    *status = OVERFLOW_ERR;
                    output[ii] = c_uint::MAX;
                } else {
                    output[ii] = input[ii] as _;
        ...
        if scale == 1.0 && zero == 0.0 {
            ...
            for ii in 0..(ntodo as usize) {
                ...
                } else if (input[ii] as f64) < DUINT_MIN {
                    *status = OVERFLOW_ERR;
                    output[ii] = c_uint::MIN;
                } else if (input[ii] as f64) > DUINT_MAX {
                    *status = OVERFLOW_ERR;
