    ...
    fn test_double_write_double_read() {
        with_temp_file(|filename| {
            ...
            unsafe {
                ...
                fits_create_img(fptr.as_mut().unwrap(), DOUBLE_IMG, naxis as c_int, &naxes, &mut status);
                fits_write_img(fptr.as_mut().unwrap(), TDOUBLE, 1, nelements as LONGLONG,
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                for i in 0..nelements {
                    assert!(floats_close_f64(write_data[i], read_data[i]),
    ...
    fn test_double_write_short_read_overflow() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 412, "Expected NUM_OVERFLOW (412) for DOUBLE → SHORT");
                ...
                assert_eq!(read_data[8], 32767, "Large overflow should clamp to SHORT max");
            }
    ...
    fn test_double_write_ushort_read_overflow() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 412, "Expected NUM_OVERFLOW (412) for DOUBLE → USHORT");
    ...
    fn test_double_write_longlong_read_success() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 0, "DOUBLE → LONGLONG should succeed without overflow");
    ...
    fn test_double_write_sbyte_read_overflow() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 412, "Expected NUM_OVERFLOW (412) for DOUBLE → SBYTE");
                ...
                assert_eq!(read_data[8], 127, "Large overflow should clamp to SBYTE max");
            }
    ...
    fn test_double_write_ulong_read_overflow() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 412, "Expected NUM_OVERFLOW (412) for DOUBLE → ULONG");
                
                // Verify clamping: negatives → 0, large values → max
                assert_eq!(read_data[0], 0, "Negative should clamp to 0");
                assert_eq!(read_data[1], 0, "Zero should convert to 0");
                assert_eq!(read_data[2], 100, "100.7 should truncate to 100");
                assert_eq!(read_data[3], c_ulong::MAX, "Max ULONG should convert exactly");
                assert_eq!(read_data[4], c_ulong::MAX, "Overflow should clamp to ULONG max");
                assert_eq!(read_data[5], c_ulong::MAX, "Large overflow should clamp to ULONG max");
            }
    ...
    fn test_double_write_ulonglong_read_overflow() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 412, "Expected NUM_OVERFLOW (412) for DOUBLE with negatives → ULONGLONG");
