...
const TEST_TABLE: &str = "!test_histo_table_rust.fit";
const TEST_HIST_OUT: &str = "!test_histo_out_rust.fit";
...
fn verify_histogram_sum(filename: &str, expected_sum: i64) -> bool {
    ...
    let filename_cstr = CString::new(filename.trim_start_matches('!')).unwrap();
    fits_open_file(
        &mut fptr,
        cast_slice(filename_cstr.to_bytes_with_nul()),
        READONLY,
...
fn test_fits_calc_binning_1d() {
    ...
    let test_file = "!test_histo_calc_binning_1d.fit";

    // Create test table
    assert_eq!(create_test_table(test_file, 100), 0);

    // Open table
    let filename = CString::new(test_file.trim_start_matches('!')).unwrap();
    fits_open_file(
        &mut fptr,
...
fn test_fits_calc_binningd_2d() {
    ...
    let test_file = "!test_histo_calc_binningd_2d.fit";
...
fn test_ffhist2_1d() {
    ...
    let test_file = "!test_histo_ffhist2_1d_table.fit";
    let hist_file = "!test_histo_ffhist2_1d_hist.fit";
    ...
    if let Some(ref mut fptr_box) = fptr {
        ...
        let hist_filename = CString::new(hist_file).unwrap();
    ...
    assert!(verify_histogram_sum(hist_file.trim_start_matches('!'), 100));
}
...
fn test_ffhist2_2d() {
    ...
    let test_file = "!test_histo_ffhist2_2d_table.fit";
    let hist_file = "!test_histo_ffhist2_2d_hist.fit";
...
fn test_ffhist2_large_dataset() {
    ...
    let test_file = "!test_histo_ffhist2_large_table.fit";
    let hist_file = "!test_histo_ffhist2_large_hist.fit";
    ...
    assert!(verify_histogram_sum(hist_file.trim_start_matches('!'), 200));
}
...
fn test_ffhist2_with_weight() {
    ...
    let test_file = "!test_histo_ffhist2_weight_table.fit";
    let hist_file = "!test_histo_ffhist2_weight_hist.fit";
...
fn test_ffhist3_1d() {
    ...
    let test_file = "!test_histo_ffhist3_1d_table.fit";
    let hist_file = "!test_histo_ffhist3_1d_hist.fit";
    ...
    assert!(verify_histogram_sum(hist_file.trim_start_matches('!'), 150));
}
...
fn test_fits_make_hist_1d() {
    ...
    let test_file = "!test_histo_make_hist_table.fit";
    let hist_file = "!test_histo_make_hist_hist.fit";
...
fn test_fits_make_histd_2d() {
    ...
    let test_file = "!test_histo_make_histd_table.fit";
    let hist_file = "!test_histo_make_histd_hist.fit";
...
fn test_fits_write_keys_histo() {
    ...
    let test_file = "!test_histo_write_keys_table.fit";
    let hist_file = "!test_histo_write_keys_hist.fit";
...
fn test_fits_rebin_wcsd() {
    ...
    let hist_file = "!test_histo_rebin_wcsd.fit";

    // Create a simple image with WCS keywords
    let filename = CString::new(hist_file).unwrap();
    fits_create_file(
        &mut fptr,
        cast_slice(filename.as_bytes_with_nul()),
        &mut status,
...
fn test_fits_rebin_wcs() {
    ...
    let hist_file = "!test_histo_rebin_wcs.fit";
