    ...
    fn test_ulonglong_write_ulonglong_read() {
        with_temp_file(|filename| {
            ...
            unsafe {
                ...
                fits_create_img(fptr.as_mut().unwrap(), ULONGLONG_IMG, naxis as c_int, &naxes, &mut status);
                fits_write_img(fptr.as_mut().unwrap(), TULONGLONG, 1, nelements as LONGLONG,
    ...
    fn test_ulonglong_write_byte_read_overflow() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 412, "Expected NUM_OVERFLOW (412) for ULONGLONG → BYTE");
    ...
    fn test_ulonglong_write_longlong_read_overflow() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 412, "Expected NUM_OVERFLOW (412) for ULONGLONG → LONGLONG");
                
                // Verify clamping to LONGLONG range
                assert_eq!(read_data[0], 0, "Zero should convert exactly");
                assert_eq!(read_data[1], 9223372036854775807, "Max LONGLONG should convert exactly");
                assert_eq!(read_data[2], 9223372036854775807, "Overflow should clamp to LONGLONG max");
                assert_eq!(read_data[3], 9223372036854775807, "Max ULONGLONG should clamp to LONGLONG max");
            }
    ...
    fn test_ulonglong_write_double_read_success() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 0, "ULONGLONG → DOUBLE should succeed without overflow");
    ...
    fn test_ulonglong_write_short_read_overflow() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 412, "Expected NUM_OVERFLOW (412) for ULONGLONG → SHORT");
    ...
    fn test_ulonglong_write_ushort_read_overflow() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 412, "Expected NUM_OVERFLOW (412) for ULONGLONG → USHORT");
    ...
    fn test_ulonglong_write_long_read_overflow() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 412, "Expected NUM_OVERFLOW (412) for ULONGLONG → LONG");
    ...
    fn test_ulonglong_write_float_read_success() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 0, "ULONGLONG → FLOAT should succeed without overflow");
    ...
    fn test_ulonglong_write_sbyte_read_overflow() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 412, "Expected NUM_OVERFLOW (412) for ULONGLONG → SBYTE");
    ...
    fn test_ulonglong_write_ulong_read_overflow() {
        ...
        with_temp_file(|filename| {
            ...
            if let Some(ref mut fptr_box) = fptr {
                ...
                assert_eq!(status, 0, "ULONGLONG → ULONG should succeed for our data range");
